/*
 * lambda.js: Transport for outputting to the lambda
 *
...
// Constructor function for the Lambda transport object responsible
// for persisting log messages and metadata to a terminal or TTY.
//
var Lambda = exports.Lambda = function (options) {
...
//
util.inherits(Lambda, Transport);

//
// Expose the name of this Transport on the prototype
//
Lambda.prototype.name = 'lambda';
...
//
Lambda.prototype.log = function (level, msg, meta, callback) {
  if (this.silent) {
